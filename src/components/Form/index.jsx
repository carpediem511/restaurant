							...
							<div className="sm:col-span-3">
								...
								<div className="mt-2">
									<input
										...
										className="pl-3 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-teal-500 outline-none sm:text-sm sm:leading-6"
									/>
								</div>
							</div>
							...
							<div className="sm:col-span-4">
								...
								<div className="mt-2">
									<input
										...
										type="text"
										autoComplete="phone"
										className="pl-3 block w-1/2 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-teal-500 outline-none sm:text-sm sm:leading-6"
									/>
								</div>
							</div>
